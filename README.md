...
| [report/technical_report.md](report/technical_report.md) | Báo cáo kỹ thuật: phương pháp, ablation, phân tích lỗi |
...
Gói ThinkFlic đầy đủ (report PDF, evidence, source code đóng gói, video) được lưu tại: [Submission Folder](https://drive.google.com/file/d/168ejPfDOSvRCde6xp-QQDb4BPIPz9Zs9/view?usp=drive_link)
